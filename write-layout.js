      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Traffikora is an AI-powered marketing automation platform for HVAC companies. Automates local SEO, Google Business Profile, social media, and AI engine optimization.",
            "offers": {
              "@type": "Offer",
              "price": "97",
              "priceCurrency": "USD"
...
`;
fs.writeFileSync('src/app/solutions/hvac/layout.tsx', content);

...
const boostDir = path.join(base, 'api', 'content', 'boost');
fs.mkdirSync(boostDir, { recursive: true });
fs.writeFileSync(path.join(boostDir, 'route.ts'), boostRoute, 'utf8');
console.log('SUCCESS: api/content/boost/route.ts');

fs.writeFileSync(path.join(base, 'dashboard', 'content', 'blog', 'page.tsx'), blogPage, 'utf8');
console.log('SUCCESS: Blog page with Boost Score button');
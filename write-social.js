...
fs.mkdirSync('src/app/dashboard/calendar', { recursive: true });

fs.writeFileSync('src/app/dashboard/calendar/layout.tsx', `// @ts-nocheck
'use client'
export default function Layout({ children }) { return <>{children}</> }
`);

fs.writeFileSync('src/app/dashboard/calendar/page.tsx', `// @ts-nocheck
'use client'
...
console.log('DONE -- Full Content Calendar written');
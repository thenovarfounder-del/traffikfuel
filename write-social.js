...
// FIX 1: Cookie banner — hide on dashboard pages
const cookieBanner = `// @ts-nocheck
'use client';
...
fs.writeFileSync('C:\\\\Users\\\\randy\\\\traffikfuel\\\\src\\\\components\\\\CookieBanner.tsx', cookieBanner, 'utf8');
console.log('SUCCESS: CookieBanner fixed — hidden on dashboard');
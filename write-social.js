...
// FILE 1: FAQ Client Component
const faqComponent = `// @ts-nocheck
'use client'
...
// FILE 2: Live Demo Client Component
const demoComponent = `// @ts-nocheck
'use client'
...
// FILE 3: Main page — SERVER COMPONENT — no 'use client'
const homePage = `// @ts-nocheck
...
fs.mkdirSync('C:\\\\Users\\\\randy\\\\traffikfuel\\\\src\\\\components', { recursive: true });
fs.writeFileSync('C:\\\\Users\\\\randy\\\\traffikfuel\\\\src\\\\components\\\\FaqAccordion.tsx', faqComponent, 'utf8');
fs.writeFileSync('C:\\\\Users\\\\randy\\\\traffikfuel\\\\src\\\\components\\\\LiveDemo.tsx', demoComponent, 'utf8');
fs.writeFileSync('C:\\\\Users\\\\randy\\\\traffikfuel\\\\src\\\\app\\\\page.tsx', homePage, 'utf8');
console.log('SUCCESS: FaqAccordion.tsx written');
console.log('SUCCESS: LiveDemo.tsx written');
console.log('SUCCESS: page.tsx rewritten as server component — no use client');
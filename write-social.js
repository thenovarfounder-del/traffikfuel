...
// Fix connect page to pass user ID as state
let connectPage = fs.readFileSync('C:\\Users\\randy\\traffikfuel\\src\\app\\dashboard\\connect\\google\\page.tsx', 'utf8');

const newConnectPage = `// @ts-nocheck
'use client'
...
fs.writeFileSync('C:\\Users\\randy\\traffikfuel\\src\\app\\dashboard\\connect\\google\\page.tsx', newConnectPage, 'utf8');
console.log('SUCCESS: Google connect page rebuilt with user ID state');

// Fix callback route to redirect to connect page not searchconsole
...
console.log('SUCCESS: Google callback redirects to connect page');
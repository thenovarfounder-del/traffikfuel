...
const dir = 'src/app/local-businesses/new-york';
...
lines.push('  title: "Marketing Automation for Small Businesses in New York | Traffikora",');
lines.push('  description: "Traffikora helps New York small businesses automate social media, SEO, Google Business Profile, and AI engine visibility. Start your free trial today.",');
lines.push('};');
lines.push('');
lines.push('export default function NewYorkPage() {');
lines.push('  return (');
lines.push('    <>');
lines.push('      <Nav />');
...
lines.push('          <h1 style={{ fontFamily: "Playfair Display, serif", fontSize: "clamp(2rem, 5vw, 3.2rem)", color: "#ffffff", marginBottom: "20px" }}>Marketing Automation for Small Businesses in New York</h1>');
...
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#E8610A", fontSize: "2rem", marginBottom: "24px" }}>Why New York Small Businesses Need Marketing Automation</h2>');
...
lines.push('          <div style={{ maxWidth: "800px", margin: "0 auto" }}>');
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#ffffff", fontSize: "2rem", marginBottom: "32px" }}>What New York Small Businesses Get With Traffikora</h2>');
lines.push('            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: "20px" }}>');
lines.push('              {[');
lines.push('                ["Daily Social Content", "Branded posts published every day to Facebook, Instagram, TikTok, and more -- keeping your New York business visible and active online without you writing a word."],');
lines.push('                ["Google Business Profile Automation", "Automated GBP posts, Q&A, and review requests that keep your listing active and ranking in Google Maps when New York customers search for your category."],');
lines.push('                ["New York Local SEO", "Citation building, schema markup, and keyword content targeting New York local searches -- pushing your business up Google rankings for the searches that matter in your market."],');
lines.push('                ["AI Engine Visibility", "Structured content that gets your business recommended when New York customers ask ChatGPT or Perplexity to find local businesses in your category."],');
lines.push('                ["Weekly Blog Content", "SEO blog posts published to your website every week -- building organic traffic from New York customers searching for the services you offer."],');
lines.push('                ["Review Automation", "Automated review requests sent to your customers -- growing your star rating and building the social proof that converts New York customers who compare options online."]');
...
lines.push('          "@type": "LocalBusiness",');
lines.push('          "name": "Traffikora",');
lines.push('          "description": "Marketing automation platform for small businesses in New York. Automates social media, SEO, Google Business Profile, and AI engine optimization.",');
lines.push('          "url": "https://www.traffikora.com/local-businesses/new-york",');
lines.push('          "areaServed": { "@type": "City", "name": "New York" },');
lines.push('          "serviceType": "Marketing Automation"');
lines.push('        })}} />');
lines.push('        <section style={{ background: "#E8610A", padding: "60px 24px", textAlign: "center" }}>');
lines.push('          <h2 style={{ fontFamily: "Playfair Display, serif", color: "#ffffff", fontSize: "2rem", marginBottom: "16px" }}>New York Businesses That Show Up Win</h2>');
lines.push('          <p style={{ color: "#ffffff", fontSize: "1.1rem", maxWidth: "560px", margin: "0 auto 32px" }}>Traffikora automates your marketing so your New York business shows up first -- on Google, on social, and on AI engines -- every single day.</p>');
...
fs.writeFileSync('src/app/local-businesses/new-york/page.tsx', content);
console.log('Done');
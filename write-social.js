...
const dir = 'C:\\Users\\randy\\traffikfuel\\src\\app\\check-email';
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: '56px', marginBottom: '24px' }}>\u{1F4E7}</div>
...
console.log('SUCCESS: check-email page written to', filePath);
...
fs.mkdirSync('src/app/dashboard/wordpress', { recursive: true });

fs.writeFileSync('src/app/dashboard/wordpress/page.tsx', `// @ts-nocheck
'use client'
...
console.log('DONE -- WordPress page written');
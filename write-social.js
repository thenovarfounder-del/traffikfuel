...
lines.push('  title: "AI Engine Optimization for Local Business | Traffikora",');
lines.push('  description: "AI engine optimization makes your business visible when people ask ChatGPT, Perplexity, or Gemini for recommendations. Traffikora automates AEO for local businesses.",');
lines.push('};');
lines.push('');
lines.push('export default function AEOPage() {');
lines.push('  return (');
lines.push('    <>');
lines.push('      <Nav />');
...
lines.push('          <h1 style={{ fontFamily: "Playfair Display, serif", fontSize: "clamp(2rem, 5vw, 3.2rem)", color: "#ffffff", marginBottom: "20px" }}>AI Engine Optimization for Local Business</h1>');
lines.push('          <p style={{ color: "#cccccc", fontSize: "1.15rem", maxWidth: "640px", margin: "0 auto 32px" }}>73% of local searches now happen on AI engines like ChatGPT, Perplexity, and Gemini. Traffikora makes sure your business gets recommended -- automatically, every day.</p>');
...
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#E8610A", fontSize: "1.5rem", marginBottom: "16px" }}>What Traffikora Does For Your AI Engine Visibility</h2>');
lines.push('            <ul style={{ color: "#cccccc", lineHeight: "2", paddingLeft: "20px" }}>');
lines.push('              <li>Builds structured data and schema markup that AI engines use to identify your business</li>');
lines.push('              <li>Creates citation-ready content that AI engines pull for local recommendations</li>');
lines.push('              <li>Establishes your business entity across platforms AI engines crawl and cite</li>');
lines.push('              <li>Maintains an llms.txt file that signals your business to AI crawlers</li>');
lines.push('              <li>Publishes declarative content written in the format AI engines cite directly</li>');
lines.push('              <li>Builds the citation authority that makes AI engines trust your business data</li>');
lines.push('            </ul>');
lines.push('          </div>');
lines.push('        </section>');
lines.push('        <section style={{ background: "#111111", padding: "60px 24px" }}>');
lines.push('          <div style={{ maxWidth: "800px", margin: "0 auto" }}>');
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#ffffff", fontSize: "2rem", marginBottom: "24px" }}>What Is AI Engine Optimization?</h2>');
...
lines.push('        <section style={{ background: "#1a1a1a", padding: "60px 24px" }}>');
lines.push('          <div style={{ maxWidth: "800px", margin: "0 auto" }}>');
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#E8610A", fontSize: "2rem", marginBottom: "24px" }}>How Traffikora Automates AI Engine Optimization for Local Business</h2>');
...
lines.push('        <section style={{ background: "#111111", padding: "60px 24px" }}>');
lines.push('          <div style={{ maxWidth: "800px", margin: "0 auto" }}>');
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#ffffff", fontSize: "2rem", marginBottom: "32px" }}>What You Get With Traffikora AI Engine Optimization</h2>');
lines.push('            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: "20px" }}>');
lines.push('              {[');
lines.push('                ["Structured Data and Schema Markup", "Automated schema markup on every page that tells AI engines exactly what your business is, where it is located, what it offers, and why it is trustworthy."],');
lines.push('                ["Citation-Ready Content", "Blog posts and page content written in clear declarative statements that AI engines can pull and cite directly when answering relevant local queries."],');
lines.push('                ["Entity Establishment", "Your business entity built and consistent across the platforms, directories, and data sources that AI engines reference when forming recommendations."],');
lines.push('                ["llms.txt Maintenance", "A structured AI signal file maintained on your domain that tells AI crawlers how to interpret and use your business information -- the new standard for AI visibility."],');
lines.push('                ["FAQ Optimization", "FAQ sections on every page written specifically to match the conversational queries people ask AI engines -- the format AI engines cite most frequently."],');
lines.push('                ["Citation Authority Building", "Consistent NAP data and citation signals across high-authority directories that AI engines use to verify and trust local business information."],');
lines.push('                ["AI-Readable Blog Content", "Weekly blog posts written with AI engine readability as a primary goal -- specific, factual, and structured to answer the questions your potential customers are asking."],');
lines.push('                ["Cross-Platform Entity Signals", "Your business information consistently published across social platforms, directories, and your website -- building the entity footprint AI engines use to confidently recommend you."]');
...
lines.push('        <section style={{ background: "#1a1a1a", padding: "60px 24px" }}>');
lines.push('          <div style={{ maxWidth: "800px", margin: "0 auto" }}>');
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#E8610A", fontSize: "2rem", marginBottom: "24px" }}>Why AI Engine Optimization Matters More in 2026</h2>');
...
lines.push('          <h2 style={{ fontFamily: "Playfair Display, serif", color: "#ffffff", fontSize: "2rem", marginBottom: "16px" }}>Get Found on ChatGPT, Perplexity, and Gemini</h2>');
lines.push('          <p style={{ color: "#ffffff", fontSize: "1.1rem", maxWidth: "560px", margin: "0 auto 32px" }}>Traffikora automates your AI engine optimization so your business gets recommended wherever your customers are searching.</p>');
...
fs.writeFileSync('src/app/features/ai-engine-optimization/page.tsx', content);
console.log('Done');
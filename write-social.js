        ...
        {!submitted ? (
          <>
            ...
            <button
              ...
              style={{ width: '100%', padding: '14px', background: loading || !email ? '#1f1f1f' : 'linear-gradient(135deg, #f97316, #ea580c)', border: 'none', borderRadius: '10px', color: loading || !email ? '#555' : '#fff', fontSize: '15px', fontWeight: '700', cursor: loading || !email ? 'not-allowed' : 'pointer' }}
            >

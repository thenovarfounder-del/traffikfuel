...
// ─── CONTENT SCORE COMPONENT ──────────────────────────────────────
const scoreComponent = `// @ts-nocheck
...
// ─── UPDATE BLOG PAGE to show content score ───────────────────────
...
// Add score calculation after post is set
blog = blog.replace(
...
// Add ContentScoreBadge in the result card header
blog = blog.replace(
...
// Write files
fs.writeFileSync('C:\\Users\\randy\\traffikfuel\\src\\components\\ContentScore.tsx', scoreComponent, 'utf8');
console.log('SUCCESS: ContentScore.tsx component created');

fs.writeFileSync('C:\\Users\\randy\\traffikfuel\\src\\app\\dashboard\\content\\blog\\page.tsx', blog, 'utf8');
console.log('SUCCESS: Blog generator — content score badge added');
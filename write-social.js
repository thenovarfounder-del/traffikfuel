...
lines.push('  title: "AI Marketing Automation Platform | Traffikora",');
lines.push('  description: "Traffikora is an AI marketing automation platform for small businesses -- automating social media, SEO, Google Business Profile, blog content, and AI engine visibility from one dashboard.",');
lines.push('};');
lines.push('');
lines.push('export default function AIMarketingAutomationPage() {');
lines.push('  return (');
lines.push('    <>');
lines.push('      <Nav />');
...
lines.push('          <h1 style={{ fontFamily: "Playfair Display, serif", fontSize: "clamp(2rem, 5vw, 3.2rem)", color: "#ffffff", marginBottom: "20px" }}>AI Marketing Automation Platform</h1>');
...
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#E8610A", fontSize: "1.5rem", marginBottom: "16px" }}>What Traffikora Automates For You</h2>');
lines.push('            <ul style={{ color: "#cccccc", lineHeight: "2", paddingLeft: "20px" }}>');
lines.push('              <li>Daily social media content creation and publishing across 9+ platforms</li>');
lines.push('              <li>Google Business Profile management -- posts, Q&A, and review requests</li>');
lines.push('              <li>Local SEO -- citation building, schema markup, and keyword content</li>');
lines.push('              <li>Weekly SEO blog posts published to your website automatically</li>');
lines.push('              <li>AI engine optimization for ChatGPT, Perplexity, and Gemini visibility</li>');
lines.push('              <li>Performance reporting across all channels from one dashboard</li>');
lines.push('            </ul>');
lines.push('          </div>');
lines.push('        </section>');
lines.push('        <section style={{ background: "#111111", padding: "60px 24px" }}>');
lines.push('          <div style={{ maxWidth: "800px", margin: "0 auto" }}>');
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#ffffff", fontSize: "2rem", marginBottom: "24px" }}>What Is an AI Marketing Automation Platform?</h2>');
...
lines.push('        <section style={{ background: "#1a1a1a", padding: "60px 24px" }}>');
lines.push('          <div style={{ maxWidth: "800px", margin: "0 auto" }}>');
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#E8610A", fontSize: "2rem", marginBottom: "24px" }}>How the Traffikora AI Marketing Automation System Works</h2>');
...
lines.push('        <section style={{ background: "#111111", padding: "60px 24px" }}>');
lines.push('          <div style={{ maxWidth: "800px", margin: "0 auto" }}>');
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#ffffff", fontSize: "2rem", marginBottom: "32px" }}>Everything Traffikora Automates For Your Business</h2>');
lines.push('            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: "20px" }}>');
lines.push('              {[');
lines.push('                ["Social Media Automation", "Daily branded content created and published to Facebook, Instagram, TikTok, YouTube, Reddit, and more -- zero writing or scheduling required from you."],');
lines.push('                ["Google Business Profile", "Automated posts, Q&A updates, and review request campaigns that keep your GBP listing active and competitive in Google Maps rankings."],');
lines.push('                ["Local SEO Automation", "Citation building, schema markup, and keyword content that pushes your business up local search rankings for the queries your customers are using."],');
lines.push('                ["Blog Content Automation", "SEO-optimized blog posts written and published to your website every week -- building organic traffic and topical authority without your involvement."],');
lines.push('                ["AI Engine Optimization", "Structured data, entity signals, and citation authority built specifically for ChatGPT, Perplexity, and Gemini visibility -- the fastest-growing local discovery channel."],');
lines.push('                ["Review Automation", "Automated review request campaigns sent to customers at the optimal moment -- growing your star rating and building the social proof that converts new prospects."],');
lines.push('                ["Performance Reporting", "A clear dashboard showing your visibility growth, content published, ranking improvements, and review count -- so you always know the system is working."],');
lines.push('                ["One Platform, Everything Connected", "Social, SEO, GBP, blog, AI engines, and reviews all managed from a single automated system. No juggling tools. No agency to manage."]');
...
lines.push('        <section style={{ background: "#1a1a1a", padding: "60px 24px" }}>');
lines.push('          <div style={{ maxWidth: "800px", margin: "0 auto" }}>');
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#E8610A", fontSize: "2rem", marginBottom: "24px" }}>Why AI Marketing for Small Business Matters More in 2026</h2>');
...
lines.push('          <h2 style={{ fontFamily: "Playfair Display, serif", color: "#ffffff", fontSize: "2rem", marginBottom: "16px" }}>Your Complete Marketing System. Running Automatically.</h2>');
lines.push('          <p style={{ color: "#ffffff", fontSize: "1.1rem", maxWidth: "560px", margin: "0 auto 32px" }}>Social, SEO, Google, blog, reviews, and AI engines -- all automated from one platform. Start today and watch your visibility grow.</p>');
...
fs.writeFileSync('src/app/features/ai-marketing-automation/page.tsx', content);
console.log('Done');
...
lines.push('  title: "Marketing Automation for Dentists | Traffikora",');
lines.push('  description: "Traffikora automates social media, Google Business Profile, SEO, and review requests for dental practices -- so you can focus on patients, not marketing.",');
lines.push('};');
lines.push('');
lines.push('export default function DentistsPage() {');
lines.push('  return (');
lines.push('    <>');
lines.push('      <Nav />');
...
lines.push('          <h1 style={{ fontFamily: "Playfair Display, serif", fontSize: "clamp(2rem, 5vw, 3.2rem)", color: "#ffffff", marginBottom: "20px" }}>Marketing Automation for Dentists</h1>');
lines.push('          <p style={{ color: "#cccccc", fontSize: "1.15rem", maxWidth: "640px", margin: "0 auto 32px" }}>New patients are searching for a dentist right now. Traffikora makes sure they find your practice first -- on Google, on social media, and on AI engines -- automatically, every day.</p>');
...
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#E8610A", fontSize: "1.5rem", marginBottom: "16px" }}>What Traffikora Does For Your Dental Practice</h2>');
lines.push('            <ul style={{ color: "#cccccc", lineHeight: "2", paddingLeft: "20px" }}>');
lines.push('              <li>Publishes branded dental health content daily across social platforms</li>');
lines.push('              <li>Keeps your Google Business Profile active with posts, Q&A, and updates</li>');
lines.push('              <li>Sends automated review requests to patients after appointments</li>');
lines.push('              <li>Builds local SEO citations so you rank when patients search for a dentist near them</li>');
lines.push('              <li>Publishes weekly SEO blog posts to your practice website automatically</li>');
lines.push('              <li>Makes your practice visible when people ask ChatGPT or Perplexity for dentist recommendations</li>');
lines.push('            </ul>');
lines.push('          </div>');
lines.push('        </section>');
lines.push('        <section style={{ background: "#111111", padding: "60px 24px" }}>');
lines.push('          <div style={{ maxWidth: "800px", margin: "0 auto" }}>');
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#ffffff", fontSize: "2rem", marginBottom: "24px" }}>Most Dental Practices Are Losing New Patients to Better Online Presence</h2>');
...
lines.push('        <section style={{ background: "#1a1a1a", padding: "60px 24px" }}>');
lines.push('          <div style={{ maxWidth: "800px", margin: "0 auto" }}>');
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#E8610A", fontSize: "2rem", marginBottom: "24px" }}>Dental SEO Automation That Fills Your Chair</h2>');
...
lines.push('        <section style={{ background: "#111111", padding: "60px 24px" }}>');
lines.push('          <div style={{ maxWidth: "800px", margin: "0 auto" }}>');
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#ffffff", fontSize: "2rem", marginBottom: "32px" }}>What Your Dental Practice Gets With Traffikora</h2>');
lines.push('            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: "20px" }}>');
lines.push('              {[');
lines.push('                ["Daily Social Content", "Oral health education, service highlights, and practice updates published every day to Facebook, Instagram, and more -- without your front desk writing or scheduling anything."],');
lines.push('                ["Google Business Profile Automation", "Automated GBP posts, Q&A updates, and profile optimization that keeps your listing active and ranking when patients search for a dentist near them."],');
lines.push('                ["Automated Review Requests", "Review campaigns sent to patients after every appointment -- systematically growing your star rating and building the social proof that converts new patient searches into booked appointments."],');
lines.push('                ["Dental Practice SEO", "Local citation building, schema markup, and keyword content targeting searches like dentist near me and family dentist in [city] -- pushing your practice up Google rankings."],');
lines.push('                ["AI Engine Visibility", "Structured content that makes your practice visible when patients ask ChatGPT or Perplexity to recommend a dentist in your area."],');
lines.push('                ["Weekly Blog Content", "Patient education articles and SEO blog posts published to your website automatically -- building organic traffic from people searching for dental services and information."],');
lines.push('                ["New Patient Pipeline", "Consistent visibility across Google, social, and AI engines means a steady flow of new patient inquiries beyond insurance referrals and word of mouth."],');
lines.push('                ["One Dashboard", "Social, SEO, reviews, and Google profile all managed automatically. No agency. No staff time. No ongoing management required."]');
...
lines.push('        <section style={{ background: "#1a1a1a", padding: "60px 24px" }}>');
lines.push('          <div style={{ maxWidth: "800px", margin: "0 auto" }}>');
lines.push('            <h2 style={{ fontFamily: "Playfair Display, serif", color: "#E8610A", fontSize: "2rem", marginBottom: "24px" }}>Why Dental Marketing Automation Matters More in 2026</h2>');
...
lines.push('          <h2 style={{ fontFamily: "Playfair Display, serif", color: "#ffffff", fontSize: "2rem", marginBottom: "16px" }}>Your Next New Patient Is Searching Right Now</h2>');
lines.push('          <p style={{ color: "#ffffff", fontSize: "1.1rem", maxWidth: "560px", margin: "0 auto 32px" }}>Traffikora makes sure they find your practice first -- on Google, on social, and on AI engines -- automatically, every day.</p>');
...
fs.writeFileSync('src/app/solutions/dentists/page.tsx', content);
console.log('Done');
...
const industryData = {
  salon: {
    label: 'Salon / Spa',
    headline: 'Here\u2019s How Traffikora Fills Your Chair Every Week',
    opener: 'your salon is competing for attention every single day \u2014 on Instagram, Google, and now AI search. Most salon owners spend hours posting manually. The ones winning locally have automated it.',
    stat: '340+ salons and spas are already on Traffikora',
    competitor: 'While you\u2019re reading this, salons in your market are publishing content automatically every day. Traffikora is how they do it.',
    ...
    freeFeature1: '3 AI blog posts/month',
    freeFeature2: 'Content dashboard access',
    freeFeature3: 'No credit card ever',
    proFeature1: 'Unlimited blogs + social content',
    proFeature2: 'AI agents running daily at 6am',
    proFeature3: 'Auto Mode \u2014 fully hands-off'
  },
  hvac: {
    label: 'HVAC / Plumbing',
    headline: 'Here\u2019s How Traffikora Gets Your Phone Ringing',
    opener: 'when someone\u2019s heat goes out at midnight and they ask Google or ChatGPT for an emergency HVAC company \u2014 the business that shows up first gets the call. Traffikora makes sure that\u2019s you.',
    stat: '210+ HVAC and plumbing companies are already on Traffikora',
    competitor: 'While you\u2019re reading this, HVAC companies in your market are publishing hyperlocal SEO content every single day. Traffikora is how they do it.',
    ...
    freeFeature2: 'Content dashboard access',
    freeFeature3: 'No credit card ever',
    proFeature1: 'AI Engine Optimization',
    proFeature2: 'AI agents running daily at 6am',
    proFeature3: 'Auto Mode \u2014 fully hands-off'
  },
  law: {
    ...
    opener: 'clients research lawyers online before ever picking up the phone. If your firm isn\u2019t showing up on Google AND AI assistants like ChatGPT and Gemini, you\u2019re invisible to the clients who are ready to hire.',
    stat: '180+ law firms are already on Traffikora',
    competitor: 'While you\u2019re reading this, competing firms in your market are publishing SEO content automatically every day. Traffikora is how they do it.',
  ...
  dental: {
    ...
    opener: 'your schedule is full \u2014 you shouldn\u2019t have to think about marketing. But patients are searching for dentists online every day, and the practices showing up consistently are the ones getting the calls.',
    stat: '220+ dental offices are already on Traffikora',
    competitor: 'While you\u2019re reading this, dental practices in your area are publishing SEO content automatically every morning. Traffikora is how they do it.',
  ...
  restaurant: {
    ...
    opener: 'people decide where to eat based on what they see online. Restaurants that post consistently \u2014 daily specials, events, behind the scenes \u2014 win the local crowd. Traffikora does all of that automatically.',
    stat: '290+ restaurants are already on Traffikora',
    competitor: 'While you\u2019re reading this, restaurants near you are posting daily content automatically across every platform. Traffikora is how they do it.',
  ...
  realestate: {
    label: 'Real Estate',
    headline: 'Here\u2019s How Traffikora Makes You the Go-To Agent in Your Market',
    opener: 'buyers and sellers research agents online before ever reaching out. The agents who publish consistently \u2014 market updates, neighborhood guides, listing spotlights \u2014 are the ones who get called first.',
    stat: '195+ real estate agents are already on Traffikora',
    competitor: 'While you\u2019re reading this, agents in your market are publishing content automatically every day. Traffikora is how they do it.',
  ...
  gym: {
    ...
    opener: 'your gym is competing against big box chains with massive marketing budgets. The way to win is consistency \u2014 showing up online every single day with content that builds your community and drives new members.',
    stat: '260+ gyms and fitness studios are already on Traffikora',
    competitor: 'While you\u2019re reading this, gyms in your market are publishing content automatically every day. Traffikora is how they do it.',
    ...
    freeFeature2: 'Content dashboard access',
    freeFeature3: 'No credit card ever',
    proFeature1: 'TikTok + YouTube Shorts',
    proFeature2: 'AI agents running daily at 6am',
    proFeature3: 'Auto Mode \u2014 fully hands-off'
  },
  medspa: {
    ...
    opener: 'med spa clients do serious research before booking. They\u2019re reading reviews, watching content, and asking AI assistants for recommendations. Traffikora makes sure your practice is what they find.',
    stat: '150+ med spas are already on Traffikora',
    competitor: 'While you\u2019re reading this, competing med spas are publishing content automatically every day. Traffikora is how they do it.',
  ...
  agency: {
    ...
    opener: 'you\u2019re doing content manually for every client \u2014 and it\u2019s eating your margins. Traffikora automates the content work so you can take on more clients, deliver better results, and actually grow.',
    stat: '120+ marketing agencies are already on Traffikora',
    competitor: 'While you\u2019re reading this, competing agencies are using Traffikora to manage more clients with less work. Don\u2019t let them get further ahead.',
    ...
    freeFeature2: 'Content dashboard access',
    freeFeature3: 'No credit card ever',
    proFeature1: '10 white-label client accounts',
    proFeature2: 'Bulk content generation',
    proFeature3: 'Client management portal'
  },
  chiro: {
    label: 'Chiropractic Practice',
    headline: 'Here\u2019s How Traffikora Brings New Patients to Your Practice',
    opener: 'patients search for chiropractors online before ever booking. If you\u2019re not showing up consistently on Google and AI assistants, you\u2019re losing those patients to practices that are.',
    stat: '170+ chiropractic practices are already on Traffikora',
    competitor: 'While you\u2019re reading this, chiropractic practices in your area are publishing SEO content automatically every day. Traffikora is how they do it.',
  ...
  auto: {
    ...
    opener: 'when someone\u2019s car breaks down and they search for a trustworthy shop nearby \u2014 the shop that shows up first gets the job. Traffikora makes sure that\u2019s you, not the dealership down the street.',
    stat: '140+ auto repair shops are already on Traffikora',
    competitor: 'While you\u2019re reading this, auto shops in your area are publishing hyperlocal SEO content automatically every day. Traffikora is how they do it.',
    ...
    freeFeature2: 'Content dashboard access',
    freeFeature3: 'No credit card ever',
    proFeature1: 'Hyperlocal SEO content',
    proFeature2: 'AI agents running daily at 6am',
    proFeature3: 'Auto Mode \u2014 fully hands-off'
  },
  other: {
    label: 'Business',
    headline: 'Here\u2019s Your Personalized Traffikora Plan',
    opener: 'whatever your business does, consistent online visibility is what drives growth. Traffikora automates your entire content marketing \u2014 blogs, social media, SEO \u2014 so you can focus on running your business.',
    stat: '1,000+ local businesses are already on Traffikora',
    competitor: 'While you\u2019re reading this, businesses in your market are publishing content automatically every day. Traffikora is how they do it.',
    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr><td style="background:linear-gradient(135deg,#1a0800,#0d0400);border-radius:16px 16px 0 0;padding:36px 40px;text-align:center;border:1px solid #2a1500;border-bottom:none;">
          ...
          <div style="color:#E8610A;font-family:Georgia,serif;font-size:12px;font-weight:600;letter-spacing:2px;text-transform:uppercase;margin-bottom:14px;">From Eva at Traffikora</div>
        ...
        <tr><td style="background:#111111;padding:36px 40px;border:1px solid #1e1e1e;border-top:none;border-bottom:none;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
            <tr>
              <td width="48%" style="background:#1a1a1a;border:1px solid #2a2a2a;border-radius:12px;padding:20px;vertical-align:top;">
                ...
                <div style="color:#fff;font-size:18px;font-weight:700;margin-bottom:16px;">$0 / forever</div>
                <div style="color:#aaa;font-size:13px;line-height:1.8;">\${biz.freeFeature1}<br>\${biz.freeFeature2}<br>\${biz.freeFeature3}</div>
              </td>
              <td width="4%"></td>
              <td width="48%" style="background:linear-gradient(135deg,#1a0800,#0d0500);border:1px solid #E8610A;border-radius:12px;padding:20px;vertical-align:top;">
                ...
                <div style="color:#fff;font-size:18px;font-weight:700;margin-bottom:16px;">$97 / month</div>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
            <tr><td style="background:linear-gradient(135deg,#1a0800,#0d0500);border:1px solid #E8610A;border-radius:12px;padding:24px;">
              ...
              <div style="color:#ffffff;font-size:22px;font-weight:700;margin-bottom:8px;">\${biz.plan}</div>
...
<body style="font-family:Arial,sans-serif;background:#f5f5f5;padding:40px 20px;">
  <table width="600" style="background:#fff;border-radius:12px;padding:32px;margin:0 auto;border:1px solid #e0e0e0;">
    <tr><td>
      ...
      <div style="color:#555;font-size:15px;margin-bottom:24px;">Someone just gave Eva their email on Traffikora.com. Eva already sent them a personalized plan summary. This is a warm lead \u2014 follow up fast.</div>
    ...
    const [visitorRes, notifyRes] = await Promise.all([
      ...
      fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          ...
          subject: \`\u{1F525} New Lead: \${biz.label} \u2014 \${visitorEmail}\`,
          html: notifyHtml
        })
      })
    ])
...
const filePath = path.join('C:\\\\', 'Users', 'randy', 'traffikfuel', 'src', 'app', 'api', 'chat', 'lead', 'route.ts')

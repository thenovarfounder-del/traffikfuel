...
`;
fs.writeFileSync('src/app/compare/traffikora-vs-reputation-com/page.tsx', content);
console.log('Written: src/app/compare/traffikora-vs-reputation-com/page.tsx');
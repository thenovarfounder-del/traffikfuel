    ...
    <>
      ...
      <section style={{ background: '#fff', padding: '80px 32px' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '18px', color: '#444', lineHeight: 1.9, marginBottom: '16px' }}><strong>1. Google Business Profile.</strong> This is the single most important local SEO asset you have. Keep it updated with fresh posts, photos, and accurate information every week.</p>
          <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '18px', color: '#444', lineHeight: 1.9, marginBottom: '16px' }}><strong>2. Citations and Consistency.</strong> Your business name, address, and phone number must be identical across every directory online. Inconsistencies confuse Google and hurt your ranking.</p>
          <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '18px', color: '#444', lineHeight: 1.9, marginBottom: '32px' }}><strong>3. Reviews.</strong> Google uses review quantity, quality, and recency as a ranking signal. More positive reviews means higher rankings and more trust.</p>
          ...
          <div style={{ background: '#f9f9f9', border: '2.5px solid #111', padding: '40px', marginTop: '48px', textAlign: 'center' }}>
            ...
            <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '17px', color: '#444', marginBottom: '28px' }}>Traffikora automates your Google Business Profile, citations, and reviews. Start your start free today today.</p>

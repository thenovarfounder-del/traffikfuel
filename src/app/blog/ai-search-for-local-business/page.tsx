    ...
    <>
      ...
      <section style={{ background: '#fff', padding: '80px 32px' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '18px', color: '#444', lineHeight: 1.9, marginBottom: '16px' }}>AI engines pull from publicly available information about your business. They look at your Google Business Profile, your reviews, your website content, local directory listings, and how consistently your information appears across the web. Businesses with strong, consistent, and frequently updated digital footprints get recommended more often.</p>

  ...
  const faqs = [
    {
      ...
      questions: [
        { q: 'What is Traffikora?', a: 'Traffikora is an AI-powered marketing automation platform built for small and mid-size businesses. You connect your accounts once, and Traffikora handles your social media, Google Business Profile, local SEO, and AI engine optimization — Google, Bing, ChatGPT, Claude, Gemini automatically — forever.' },
    ...
    },
    {
      ...
      questions: [
        ...
        { q: 'How is Traffikora different from Mailchimp or Constant Contact?', a: 'Mailchimp and Constant Contact are email marketing tools. They have no social media automation, no Google Business Profile management, no local SEO, and no AI engine optimization — Google, Bing, ChatGPT, Claude, Gemini. Traffikora covers all of these channels automatically.' },

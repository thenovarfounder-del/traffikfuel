...
export default function FaqPage() {
  ...
  const faqs = [
    ...
    },
    {
      category: 'Features',
      questions: [
        { q: 'What does Traffikora actually do for my business?', a: 'Traffikora automates six core marketing functions: social media content creation and publishing, Google Business Profile management, local SEO optimization, Google SEO + Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini, review generation, and monthly performance reporting. All of it runs automatically after your initial setup.' },
    ...
    },
    {
      ...
      questions: [
        ...
        { q: 'How is Traffikora different from Mailchimp or Constant Contact?', a: 'Mailchimp and Constant Contact are email marketing tools. They have no social media automation, no Google Business Profile management, no local SEO, and no Google SEO + Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini. Traffikora covers all of these channels automatically.' },

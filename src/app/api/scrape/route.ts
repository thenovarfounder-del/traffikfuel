  ...
  try {
    ...
    const claudeRes = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: 'user',
          content: `Extract a business brain from this website as JSON with these exact fields: business_name, industry, tagline, services (array), target_audience, tone, unique_value_proposition, location. Return only valid JSON, no markdown, no explanation.\n\n${text}`
        }],
      }),
    });

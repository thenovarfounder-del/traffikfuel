    ...
    <>
      ...
      <main style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <section style={{ background: '#fff', padding: '80px 40px', borderBottom: '2.5px solid #111' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            {[
              ...
              { step: '3', title: 'Watch it work forever', desc: 'Traffikora starts generating and publishing content immediately. Blog posts, social media updates, schema markup, AI engine optimization all happening automatically, every single day, while you focus on running your business.', detail: 'Most customers see their first content published within minutes of completing setup. Rankings typically start improving within 2 to 4 weeks. AI engine citations begin appearing within 30 days.' },
            ].map((item, i) => (
        ...
        <section style={{ background: '#fff', padding: '80px 40px', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '16px', color: '#555', maxWidth: '440px', margin: '0 auto 32px', lineHeight: 1.8 }}>7-day free trial. No charge until day 8. Cancel anytime.</p>

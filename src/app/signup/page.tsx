...
function SignupForm() {
  ...
  const plans = {
    starter: { name: 'Starter', price: '$97/mo', priceId: 'price_1TUvcsHuRIVTwN2fMNH7SjRh' },
    pro: { name: 'Pro', price: '$197/mo', priceId: 'price_1TUve7HuRIVTwN2fYvrd1UgG' },
    agency: { name: 'Agency', price: '$797/mo', priceId: 'price_1TUvfKHuRIVTwN2fzlinyhei' },
    enterprise: { name: 'Enterprise', price: '$1,497/mo', priceId: 'price_1TUvgSHuRIVTwN2fhUwmR6Kb' },
  }
    ...
    <>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .signup-left > div > p { font-size: 17px; color: #aaa; line-height: 1.7; margin-bottom: 36px; }
        ...
        .signup-right { padding: 60px; display: flex; flex-direction: column; justify-content: center; max-width: 520px; margin: 0 auto; width: 100%; }
        ...
        @media (max-width: 768px) {
          ...
          .signup-right { padding: 40px 24px; max-width: 100%; }
        }
      `}</style>
      <Suspense fallback={<div style={{padding: '60px', fontFamily: 'sans-serif'}}>Loading...</div>}>
        <SignupForm />
      </Suspense>
    </>
  )

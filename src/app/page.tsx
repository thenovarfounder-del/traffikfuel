...
<style>@keyframes fadeInUp{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}</style>
        ...
        <div style="background:#0d0d0d;border-top:2.5px solid #111;border-bottom:2.5px solid #111;padding:40px"><div style="text-align:center;margin-bottom:28px"><span style="font-size:11px;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:#E8610A;display:block;margin-bottom:8px">Trusted across industries</span><div style="font-family:'Playfair Display',serif;font-size:28px;font-weight:700;color:#fff">Works for <em style="color:#E8610A;font-style:italic">your</em> business &mdash; whatever it is.</div><p style="font-size:14px;color:#666;margin-top:8px;font-weight:300">Every piece of content tailored to your industry, your city, and your customers.</p></div><div style="display:grid;grid-template-columns:repeat(6,1fr);gap:12px;max-width:1100px;margin:0 auto"><div style="background:#141414;cursor:pointer;border:1px solid #2a2a2a;border-radius:12px;padding:18px 12px;text-align:center;cursor:default" onmouseover="this.style.borderColor='#E8610A';this.style.background='#1a1a1a'" onmouseout="this.style.borderColor='#2a2a2a';this.style.background='#141414'"><div style="font-size:26px;margin-bottom:8px">&#128135;</div><div style="font-size:12px;font-weight:700;color:#fff;line-height:1.3;margin-bottom:4px;cursor:pointer" onclick="window.location.href='/solutions/salons'">Salons &amp; Spas</div><div style="font-size:10px;color:#555;line-height:1.4">Bookings + reviews on autopilot</div></div><div style="background:#141414;cursor:pointer;border:1px solid #2a2a2a;border-radius:12px;padding:18px 12px;text-align:center;cursor:default" onmouseover="this.style.borderColor='#E8610A';this.style.background='#1a1a1a'" onmouseout="this.style.borderColor='#2a2a2a';this.style.background='#141414'"><div style="font-size:26px;margin-bottom:8px">&#128295;</div><div style="font-size:12px;font-weight:700;color:#fff;line-height:1.3;margin-bottom:4px;cursor:pointer" onclick="window.location.href='/solutions/hvac'">HVAC Companies</div><div style="font-size:10px;color:#555;line-height:1.4">Dominate local search year-round</div></div><div style="background:#141414;cursor:pointer;border:1px solid #2a2a2a;border-radius:12px;padding:18px 12px;text-align:center;cursor:default" onmouseover="this.style.borderColor='#E8610A';this.style.background='#1a1a1a'" onmouseout="this.style.borderColor='#2a2a2a';this.style.background='#141414'"><div style="font-size:26px;margin-bottom:8px">&#9878;</div><div style="font-size:12px;font-weight:700;color:#fff;line-height:1.3;margin-bottom:4px;cursor:pointer" onclick="window.location.href='/solutions/lawyers'">Law Firms</div><div style="font-size:10px;color:#555;line-height:1.4">Authority content that converts</div></div><div style="background:#141414;cursor:pointer;border:1px solid #2a2a2a;border-radius:12px;padding:18px 12px;text-align:center;cursor:default" onmouseover="this.style.borderColor='#E8610A';this.style.background='#1a1a1a'" onmouseout="this.style.borderColor='#2a2a2a';this.style.background='#141414'"><div style="font-size:26px;margin-bottom:8px">&#129463;</div><div style="font-size:12px;font-weight:700;color:#fff;line-height:1.3;margin-bottom:4px;cursor:pointer" onclick="window.location.href='/solutions/dentists'">Dental Offices</div><div style="font-size:10px;color:#555;line-height:1.4">New patient content daily</div></div><div style="background:#141414;cursor:pointer;border:1px solid #2a2a2a;border-radius:12px;padding:18px 12px;text-align:center;cursor:default" onmouseover="this.style.borderColor='#E8610A';this.style.background='#1a1a1a'" onmouseout="this.style.borderColor='#2a2a2a';this.style.background='#141414'"><div style="font-size:26px;margin-bottom:8px">&#127869;</div><div style="font-size:12px;font-weight:700;color:#fff;line-height:1.3;margin-bottom:4px;cursor:pointer" onclick="window.location.href='/solutions/restaurants'">Restaurants</div><div style="font-size:10px;color:#555;line-height:1.4">Specials, events, reviews automated</div></div><div style="background:#141414;cursor:pointer;border:1px solid #2a2a2a;border-radius:12px;padding:18px 12px;text-align:center;cursor:default" onmouseover="this.style.borderColor='#E8610A';this.style.background='#1a1a1a'" onmouseout="this.style.borderColor='#2a2a2a';this.style.background='#141414'"><div style="font-size:26px;margin-bottom:8px">&#127968;</div><div style="font-size:12px;font-weight:700;color:#fff;line-height:1.3;margin-bottom:4px;cursor:pointer" onclick="window.location.href='/solutions/real-estate'">Real Estate</div><div style="font-size:10px;color:#555;line-height:1.4">Listings found on every AI engine</div></div><div style="background:#141414;cursor:pointer;border:1px solid #2a2a2a;border-radius:12px;padding:18px 12px;text-align:center;cursor:default" onmouseover="this.style.borderColor='#E8610A';this.style.background='#1a1a1a'" onmouseout="this.style.borderColor='#2a2a2a';this.style.background='#141414'"><div style="font-size:26px;margin-bottom:8px">&#128170;</div><div style="font-size:12px;font-weight:700;color:#fff;line-height:1.3;margin-bottom:4px;cursor:pointer" onclick="window.location.href='/solutions/gyms'">Gyms &amp; Fitness</div><div style="font-size:10px;color:#555;line-height:1.4">Membership growth content</div></div><div style="background:#141414;cursor:pointer;border:1px solid #2a2a2a;border-radius:12px;padding:18px 12px;text-align:center;cursor:default" onmouseover="this.style.borderColor='#E8610A';this.style.background='#1a1a1a'" onmouseout="this.style.borderColor='#2a2a2a';this.style.background='#141414'"><div style="font-size:26px;margin-bottom:8px">&#128663;</div><div style="font-size:12px;font-weight:700;color:#fff;line-height:1.3;margin-bottom:4px;cursor:pointer" onclick="window.location.href='/solutions/auto-repair'">Auto Repair</div><div style="font-size:10px;color:#555;line-height:1.4">Local SEO that drives walk-ins</div></div><div style="background:#141414;cursor:pointer;border:1px solid #2a2a2a;border-radius:12px;padding:18px 12px;text-align:center;cursor:default" onmouseover="this.style.borderColor='#E8610A';this.style.background='#1a1a1a'" onmouseout="this.style.borderColor='#2a2a2a';this.style.background='#141414'"><div style="font-size:26px;margin-bottom:8px">&#127973;</div><div style="font-size:12px;font-weight:700;color:#fff;line-height:1.3;margin-bottom:4px;cursor:pointer" onclick="window.location.href='/solutions/med-spas'">Med Spas</div><div style="font-size:10px;color:#555;line-height:1.4">Premium content for premium clients</div></div><div style="background:#141414;cursor:pointer;border:1px solid #2a2a2a;border-radius:12px;padding:18px 12px;text-align:center;cursor:default" onmouseover="this.style.borderColor='#E8610A';this.style.background='#1a1a1a'" onmouseout="this.style.borderColor='#2a2a2a';this.style.background='#141414'"><div style="font-size:26px;margin-bottom:8px">&#128694;</div><div style="font-size:12px;font-weight:700;color:#fff;line-height:1.3;margin-bottom:4px;cursor:pointer" onclick="window.location.href='/solutions/plumbers'">Plumbers</div><div style="font-size:10px;color:#555;line-height:1.4">Emergency leads around the clock</div></div><div style="background:#141414;cursor:pointer;border:1px solid #2a2a2a;border-radius:12px;padding:18px 12px;text-align:center;cursor:default" onmouseover="this.style.borderColor='#E8610A';this.style.background='#1a1a1a'" onmouseout="this.style.borderColor='#2a2a2a';this.style.background='#141414'"><div style="font-size:26px;margin-bottom:8px">&#128226;</div><div style="font-size:12px;font-weight:700;color:#fff;line-height:1.3;margin-bottom:4px;cursor:pointer" onclick="window.location.href='/solutions/marketing-agencies'">Agencies</div><div style="font-size:10px;color:#555;line-height:1.4">White-label for all your clients</div></div><div style="background:#141414;cursor:pointer;border:1px solid #2a2a2a;border-radius:12px;padding:18px 12px;text-align:center;cursor:default" onmouseover="this.style.borderColor='#E8610A';this.style.background='#1a1a1a'" onmouseout="this.style.borderColor='#2a2a2a';this.style.background='#141414'"><div style="font-size:26px;margin-bottom:8px">&#129658;</div><div style="font-size:12px;font-weight:700;color:#fff;line-height:1.3;margin-bottom:4px;cursor:pointer" onclick="window.location.href='/solutions/chiropractors'">Chiropractors</div><div style="font-size:10px;color:#555;line-height:1.4">Patient education that ranks</div></div></div></div>

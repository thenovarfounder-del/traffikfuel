    ...
    <>
      ...
      <main suppressHydrationWarning>
        ...
        <section style={{ background: "#E8610A", padding: "60px 24px", textAlign: "center" }}>
          ...
          <p style={{ color: "#ffffff", fontSize: "1.1rem", maxWidth: "560px", margin: "0 auto 32px" }}>Traffikora executes your local SEO automatically -- citations, content, Google profile, and Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini -- every week without you touching it.</p>

...
export default function SproutSocialComparePage() {
  return (
    <>
      ...
      <section style={{ background: '#111', color: '#fff', textAlign: 'center', padding: '90px 32px' }}>
        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '13px', fontWeight: 600, letterSpacing: '2px', color: '#E8610A', textTransform: 'uppercase', marginBottom: '16px' }}>Traffikora vs Sprout Social</p>
        <h1 style={{ fontFamily: 'Playfair Display, serif', fontSize: '54px', fontWeight: 900, lineHeight: 1.1, maxWidth: '820px', margin: '0 auto 24px' }}>Traffikora vs Sprout Social: Which Is Right for Your Business?</h1>
        <p style={{ fontSize: '19px', color: '#ccc', maxWidth: '620px', margin: '0 auto 40px' }}>Sprout Social is an enterprise social media management tool. Traffikora is a fully automated marketing machine built for small businesses.</p>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontFamily: 'DM Sans, sans-serif' }}>
              <thead>
                <tr style={{ background: '#111', color: '#fff' }}>
                  ...
                  <th style={{ padding: '16px 24px', textAlign: 'center', fontSize: '15px' }}>Sprout Social</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  ['Free plan available', '✅', '❌'],
                ].map(([feature, traffikora, sprout], i) => (
                  <tr key={feature} style={{ background: i % 2 === 0 ? '#f7f7f7' : '#fff', borderBottom: '1px solid #e5e5e5' }}>
                    ...
                    <td style={{ padding: '16px 24px', textAlign: 'center', fontSize: '18px' }}>{sprout}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <section style={{ background: '#f7f7f7', padding: '80px 32px' }}>
        <div style={{ maxWidth: '1060px', margin: '0 auto' }}>
          ...
          <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '18px', color: '#444', maxWidth: '700px', margin: '0 auto 56px', textAlign: 'center' }}>Sprout Social is a powerful tool for enterprise social media teams with dedicated staff to manage it. For a small business owner, it’s expensive, complex, and still requires you to do all the work yourself.</p>

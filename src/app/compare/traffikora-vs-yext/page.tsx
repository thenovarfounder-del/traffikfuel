      ...
      <main suppressHydrationWarning>
        ...
        <section style={{ background: "#111111", padding: "60px 24px" }}>
          <div style={{ maxWidth: "800px", margin: "0 auto" }}>
            ...
            <p style={{ color: "#cccccc", lineHeight: "1.8", marginBottom: "16px" }}>Yext pricing starts around $500 per month for meaningful coverage and scales up significantly for multi-location businesses. For that price, you get accurate listings -- and nothing else. No social media content. No Google Business Profile posts. No blog content. No review automation. No Google SEO + Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini. You are paying a premium for data synchronization while all the active marketing work still falls on you.</p>
        ...
        <section style={{ background: "#E8610A", padding: "60px 24px", textAlign: "center" }}>
          ...
          <p style={{ color: "#ffffff", fontSize: "1.1rem", maxWidth: "560px", margin: "0 auto 32px" }}>Traffikora handles your citations, social media, Google profile, SEO, and Google SEO + Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini -- automatically, every day.</p>

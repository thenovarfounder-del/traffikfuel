  ...
  return (
    <>
      ...
      <section style={{ background: '#111', color: '#fff', textAlign: 'center', padding: '90px 32px' }}>
        ...
        <h1 style={{ fontFamily: 'Playfair Display, serif', fontSize: '54px', fontWeight: 900, lineHeight: 1.1, maxWidth: '820px', margin: '0 auto 24px' }}>Traffikora vs Yext</h1>
        <p style={{ fontSize: '19px', color: '#ccc', maxWidth: '620px', margin: '0 auto 40px' }}>See why small businesses choose Traffikora over Yext for automated, AI-powered marketing.</p>
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0', border: '2.5px solid #111', marginBottom: '64px' }}>
            ...
            <div style={{ padding: '20px 24px', textAlign: 'center', background: '#f8f8f8' }}>
              <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '13px', fontWeight: 600, color: '#555' }}>Yext</p>
            </div>
            {rows.map((row, i) => (
              <>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '17px', color: '#444', maxWidth: '640px', margin: '0 auto 40px', lineHeight: 1.8 }}>Yext does some things well. But it wasn’t built for small businesses who need everything automated in one place — including AI engine optimization. Traffikora was.</p>

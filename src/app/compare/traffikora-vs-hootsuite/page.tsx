      ...
      <main suppressHydrationWarning>
        ...
        <section style={{ background: "#111111", padding: "60px 24px" }}>
          <div style={{ maxWidth: "800px", margin: "0 auto" }}>
            ...
            {[
              ["What is the main difference between Traffikora and Hootsuite?", "The main difference is content creation. Hootsuite is a scheduling tool -- it helps you organize and publish content you have already written. Traffikora creates the content for you and publishes it automatically. You do not write anything. Beyond social media, Traffikora also handles SEO, Google Business Profile, blog content, review requests, and AI engine optimization -- none of which Hootsuite covers."],

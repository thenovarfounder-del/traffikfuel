      ...
      <section style={{ background: '#fff', padding: '80px 32px' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '17px', color: '#444', maxWidth: '640px', margin: '0 auto 40px', lineHeight: 1.8 }}>Mailchimp does some things well. But it wasn’t built for small businesses who need everything automated in one place — including Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini. Traffikora was.</p>

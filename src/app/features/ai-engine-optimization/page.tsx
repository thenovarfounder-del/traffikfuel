...
export const metadata = {
  ...
  description: "Google SEO + Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini makes your business visible when people ask ChatGPT, Perplexity, or Gemini for recommendations. Traffikora automates AEO for local businesses.",
};
      ...
      <main suppressHydrationWarning>
        ...
        <section style={{ background: "#111111", padding: "60px 24px" }}>
          <div style={{ maxWidth: "800px", margin: "0 auto" }}>
            ...
            <p style={{ color: "#cccccc", lineHeight: "1.8", marginBottom: "16px" }}>Google SEO + Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini (AEO) is the process of making a business visible and citable when people ask AI engines -- ChatGPT, Perplexity, Gemini, Claude, and others -- for recommendations, comparisons, or local business suggestions. It is the evolution of traditional SEO for a world where search behavior has shifted from typing queries into Google to asking conversational questions to AI assistants.</p>
        ...
        <section style={{ background: "#111111", padding: "60px 24px" }}>
          <div style={{ maxWidth: "800px", margin: "0 auto" }}>
            ...
            {[
              ["What is Google SEO + Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini for local business?", "Google SEO + Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini (AEO) for local business is the process of building the content signals, structured data, entity authority, and citation consistency that cause AI engines like ChatGPT, Perplexity, and Gemini to recommend your business when users ask relevant local questions. It is distinct from traditional SEO in that it focuses on the signals AI language models use to form responses rather than the ranking factors Google uses to order search results."],
              ["How is AEO different from traditional SEO?", "Traditional SEO optimizes for Google's ranking algorithm -- keyword relevance, backlinks, page speed, and structured data. Google SEO + Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini focuses on the signals that language models use to identify trustworthy, citable local businesses -- entity consistency, declarative content, FAQ structure, citation authority, and cross-platform presence. Traffikora builds both simultaneously because local businesses need visibility on both channels."],
              ...
              ["Does Traffikora handle both SEO and Google SEO + Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini?", "Yes. Traffikora builds traditional local SEO -- citations, schema markup, keyword content, Google Business Profile -- and Google SEO + Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini simultaneously. Every action taken to improve your local SEO also contributes to your AI engine visibility, and the AI-specific signals Traffikora builds add an additional layer on top. You get complete local search visibility from one automated platform."]
            ].map(([q, a]) => (
        ...
        <section style={{ background: "#E8610A", padding: "60px 24px", textAlign: "center" }}>
          ...
          <p style={{ color: "#ffffff", fontSize: "1.1rem", maxWidth: "560px", margin: "0 auto 32px" }}>Traffikora automates your Google SEO + Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini so your business gets recommended wherever your customers are searching.</p>

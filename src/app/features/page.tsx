...
export default function FeaturesPage() {
  const features = [
    ...
    { icon: '🤖', name: 'AI Engine Optimization', desc: 'Get found when people ask ChatGPT, Claude, Gemini, or Perplexity to recommend a business like yours. This is the most powerful and most ignored marketing channel available today.' },

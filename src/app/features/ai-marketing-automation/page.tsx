      ...
      <main suppressHydrationWarning>
        ...
        <section style={{ background: "#1a1a1a", padding: "60px 24px" }}>
          <div style={{ maxWidth: "800px", margin: "0 auto" }}>
            ...
            <ul style={{ color: "#cccccc", lineHeight: "2", paddingLeft: "20px" }}>
              ...
              <li>Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini for ChatGPT, Perplexity, and Gemini visibility</li>
        ...
        <section style={{ background: "#1a1a1a", padding: "60px 24px" }}>
          <div style={{ maxWidth: "800px", margin: "0 auto" }}>
            ...
            <p style={{ color: "#cccccc", lineHeight: "1.8", marginBottom: "16px" }}>The SEO layer runs in parallel. Traffikora builds your local citations, adds schema markup to your website pages, and publishes keyword-targeted content that builds your organic search rankings over time. The Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini layer builds on top of the SEO foundation -- adding the structured signals, entity establishment, and citation authority that cause AI engines like ChatGPT and Perplexity to recommend your business when users ask relevant local questions.</p>
        ...
        <section style={{ background: "#111111", padding: "60px 24px" }}>
          <div style={{ maxWidth: "800px", margin: "0 auto" }}>
            ...
            {[
              ...
              ["Do I need any marketing knowledge to use Traffikora?", "No. Traffikora is built for business owners, not marketers. You connect your accounts, confirm your business details, and the platform handles everything from there. You do not need to understand SEO, social media strategy, content marketing, or Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini. Traffikora applies best practices across all channels automatically based on your business profile."],
              ["How quickly does Traffikora start working?", "Traffikora starts producing output the same day you set up your account. Social content begins publishing immediately. Google Business Profile management starts within the first few days. SEO citation building begins in the first week. Blog content starts publishing on a weekly schedule. Google SEO + all AI engines — Google, Bing, ChatGPT, Claude, Gemini signals build from day one and strengthen over time."],

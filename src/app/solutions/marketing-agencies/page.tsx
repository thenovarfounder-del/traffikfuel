          ...
          <div style={{ maxWidth: "800px", margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: "20px" }}>
              {[
                ...
                ["Google SEO + AI Engine Optimization", "Structured content and entity signals built for every client -- making your agency one of the few delivering AI engine visibility as a standard service offering."],

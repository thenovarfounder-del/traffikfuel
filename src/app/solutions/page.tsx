...
export default function SolutionsPage() {
  const industries = [
    ...
    { emoji: '🔧', name: 'HVAC Companies', desc: 'Dominate local searches when homeowners need heating and cooling help.', href: '/solutions/small-businesses' },
    { emoji: '⚖️', name: 'Law Firms', desc: 'Get found when people search for legal help in your area on Google and AI engines.', href: '/solutions/small-businesses' },
    { emoji: '🦷', name: 'Dental Offices', desc: 'Attract new patients automatically with content that ranks and converts.', href: '/solutions/small-businesses' },
    ...
    { emoji: '💪', name: 'Gyms and Fitness', desc: 'Grow your membership with automated content that speaks to local fitness seekers.', href: '/solutions/small-businesses' },
    ...
    { emoji: '🏥', name: 'Med Spas', desc: 'Attract high-value clients with premium content automation across all platforms.', href: '/solutions/small-businesses' },
    { emoji: '🔩', name: 'Plumbers', desc: 'Show up first when locals search for emergency plumbing day or night.', href: '/solutions/small-businesses' },
    { emoji: '📣', name: 'Agencies', desc: 'Manage all your clients from one dashboard with white-label reporting.', href: '/solutions/small-businesses' },

...
export default function DashboardPage() {
  ...
  const sections = [
    {id:'home',label:'Home'},{id:'onboarding',label:'Onboarding'},
    {id:'publish',label:'Publish'},{id:'content',label:'Content'},
    {id:'rankings',label:'Rankings'},{id:'audits',label:'Audits'},
    {id:'backlinks',label:'Backlinks'},{id:'analytics',label:'Analytics'},
    {id:'monetize',label:'Monetize'},{id:'integrations',label:'Integrations'},
    ...
    <div style={{display:'flex',height:'100vh',background:'#0a0a0a',color:'white'}}>
      <div style={{width:'220px',background:'#111',borderRight:'1px solid #222',padding:'20px 0',display:'flex',flexDirection:'column'}}>
        ...
        <button onClick={()=>router.push('/dashboard/business')}
          ...
          textAlign:'left',cursor:'pointer',fontSize:'14px',borderLeft:'3px solid transparent',
          marginTop:'4px'}}>
          Business
        </button>

...
export default function DashboardPage() {
  ...
  const cards = [
    ...
    { title: 'Business Brain', desc: 'Enter your website URL and AI builds your complete marketing profile automatically.', href: '/dashboard/scrape', btn: 'Build Brain', color: '#111' },
    { title: 'Business Settings', desc: 'Set up your business name, category, city and website.', href: '/dashboard/settings', btn: 'Go to Settings', color: '#111' },
    ...
    { title: 'Connect X / Twitter', desc: 'Link your X account to publish posts and track engagement.', href: '/dashboard/connect/twitter', btn: 'Connect', color: '#000' },
    ...
    { title: 'Billing', desc: 'Manage your subscription, view invoices, and update payment details.', href: '/dashboard/billing', btn: 'View Billing', color: '#111' },
    { title: 'Support', desc: 'Need help? Our team is standing by.', href: '/support', btn: 'Get Help', color: '#111' },
  ]
    ...
    <main style={{ background: '#f7f7f7', minHeight: '100vh' }}>
      ...
      <div style={{ padding: '32px 40px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: '20px' }}>
          {cards.map((card, i) => (
            <div key={i} style={{ background: '#fff', border: '2px solid #e8e8e8', padding: '24px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <h2 style={{ fontFamily: 'Playfair Display, serif', fontSize: '18px', fontWeight: 700, color: '#111', margin: 0 }}>{card.title}</h2>
